...
class NetworkAdapter(context: Context): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, viewGroup: ViewGroup?): View {
        ...
        peerCountView.text = mContext.resources.getString(R.string.SETTINGS_peer_count, node.peercount)
        blockCountView.text = mContext.resources.getString(R.string.SETTINGS_block_count, node.blockcount)
